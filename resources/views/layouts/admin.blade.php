        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
              {{--  <a class="navbar-brand" href="{{ url('/dashboard') }}">
                ...
                <p class="opennav" onclick="nav()" ><i class="fas fa-bars"></i></p>
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link text-center dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    <img class="avatarr" height="50px" width="50px" src="{{asset('images/users/'. Auth::user()->avatar)}}" alt="" >
                                      <br>
                                    {{ Auth::user()->name }}
